...
namespace ApniMaa.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        /// </summary>
        protected PermissonAndDetailModel LOGGEDIN_USER { get; set; }
        #endregion
        ...
        protected JsonResult JsonResultSuccess(string message, object model = null, List<string> list = null)
        {
            return Json(new ActionOutput() { Status = ActionStatus.Successfull, Message = message, Results = list }, JsonRequestBehavior.AllowGet);
        }

        protected JsonResult JsonResultError(string message, object model = null, List<string> list = null)
        {
            return Json(new ActionOutput() { Status = ActionStatus.Error, Message = message, Results = list }, JsonRequestBehavior.AllowGet);
        }
